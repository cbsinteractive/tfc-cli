...
func TestWorkspacesUnsetWorkingDirectory(t *testing.T) {
	...
	testConfigs := []struct {
	...
	}{
		{
			...
			inputConfig{
				[]string{"-workspace", "someworkspace"},
				"someorg",
				"sometoken",
				"someworkspace",
			},
	...
	for _, test := range testConfigs {
		t.Run(test.description, func(t *testing.T) {
			args := append([]string{"workspaces", "unset-working-directory"}, test.inputConfig.args...)
