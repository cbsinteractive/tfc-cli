...
func TestWorkspacesSetDescription(t *testing.T) {
	...
	testConfigs := []struct {
	...
	}{
		{
			"Updates description",
			inputConfig{
				[]string{"-workspace", "someworkspace", "-description", "some description"},
				"someorg",
				"sometoken",
				"someworkspace",
				"some description",
	...
	for _, test := range testConfigs {
		t.Run(test.description, func(t *testing.T) {
			args := append([]string{"workspaces", "set-description"}, test.inputConfig.args...)
